...
//   void _initializeRouteOnMap() {
//     // Haritaya rotayı yerleştir (marker ve çizgiler)
//     _createMarkersFromRoute();
//     _createPolyline();
//   }
...
//     // Rota üzerinde ara noktalar (max 8 nokta)
//     if (locations.length > 2) {
//       final step = max(1, (locations.length - 2) ~/ 8);
//       for (int i = step; i < locations.length - 1; i += step) {
//         markers.add(_createMarker(
...
//         title: title,
//         snippet:
//             'Tarih: ${_formatDateTime(DateTime.fromMillisecondsSinceEpoch(location.timestamp.millisecondsSinceEpoch))}',
//       ),
//     );
//   }
...
//             polylines: _polylines,
//             mapType: MapType.normal,
//             myLocationEnabled: false, // Konum takibi kapalı
//             myLocationButtonEnabled: false, // Konum butonları kapalı
//             zoomControlsEnabled: true,
//             onMapCreated: (controller) {
//               _mapController = controller;
//               _fitMapToRoute();
...
//     // Rotanın başlangıç noktasına odaklan
//     final firstLocation = widget.route.locationPoints.first;
//     return CameraPosition(
//       target: LatLng(firstLocation.latitude, firstLocation.longitude),
//       zoom: 14,
...
//     // Rotanın tüm noktalarını içine alan bir sınır oluştur
//     double minLat = 90.0;
//     double maxLat = -90.0;
//     double minLng = 180.0;
//     double maxLng = -180.0;
...
//   void initState() {
//     super.initState();
//     // Sadece bir kez çalıştır, sonra güncelleme olmasın
//     _initializeRouteOnMap();
//   }
